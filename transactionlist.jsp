...
<%
                      ...
                      try {
                         ...
                         PreparedStatement transactionData = conn.prepareStatement("SELECT `tid`,`id`, `date`, `amount`, `email`,`mobileNo` FROM `transaction`, `user` WHERE transaction.uid = user.id");
...
<body>
    ...
    <div class="dashboard">
                ...
                <ul>
                    ...
                    <li class="active">
                        <div class="li"><i class="fa-thin fa-memo-circle-check"></i>
                            <div class="practice"><a href="transactionlist.jsp" class="active-link">Transactions</a></div>
                        </div>
                    </li>
            </div>
        </nav>
        ...
        <div class="header">
            ...
            <h1 class="dashboard-text">Transactions</h1>
